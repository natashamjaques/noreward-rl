...
'FORWARD_SIZES': [256, 128],         # list of layer sizes for the forward model. If empty will connect directly to predicting embedding.
'INVERSE_SIZES': [256, 128],         # list of layer sizes for the inverse model. If empty will connect directly to predicting embedding.
}
