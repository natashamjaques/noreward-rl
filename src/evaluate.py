...
def inference(args):
    ...
    outdir = os.path.join(args.log_dir, 'evaluate') if args.out_dir is None else args.out_dir
            ...
            for i in range(eps_to_complete):
                ...
                while True:
                    ...
                    if terminal or length >= timestep_limit:
                        ...
                        results_dict = {'episode_num':i, 'reward': reward}
                        if 'distance' in info:
                            print('Mario Distance Covered:', info['distance'])
                            mario_distances[i] = info['distance']
                            results_dict['distance'] = info['distance']
...
def main(_):
    ...
    parser.add_argument('--out-dir', default=None, help='output log directory. Default: log_dir/evaluate/')
    ...
    parser.add_argument('--descriptor', type=str, default='evaluation',
                    help="String name used for evaluation")
